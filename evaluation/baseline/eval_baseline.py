...
Generates comprehensive evaluation metrics for the baseline classifier (no SSL).

Usage:
    python evaluate_baseline.py

Output:
    - Confusion matrix: ./output/baseline/confusion_matrix.png
    - Classification report: printed to console
    - Metrics saved: ./output/baseline/evaluation_metrics.txt
"""
...
DATASET_DIR = './dataset'
TEST_FILE = 'Test.csv'
MODEL_PATH = './output/baseline/best_baseline_classifier.keras'
...
print("=" * 70)
print("Baseline Classifier Evaluation (No SSL)")
print("=" * 70)
...
plt.title('Baseline Classifier (No SSL) - Confusion Matrix')
...
plt.title('ROC Curves - Baseline Classifier (No SSL)')
plt.legend()
...
with open(metrics_path, 'w') as f:
    f.write("Baseline Classifier (No SSL) - Evaluation Metrics\n")
    f.write("=" * 70 + "\n\n")
